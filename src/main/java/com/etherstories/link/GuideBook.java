    ...
    static ItemStack written() {
        ...
        meta.setPages(List.of(
                ...
                page("上架 / 下架 / 取回",
                        ...
                        "在聊天栏输入本服单价。",
                        "插件按本服汇率换成互通价格记账。",
                        "别人看到的是对方服务器换算后的实付（含税）。",
                        "管理可在「互通设置」调整汇率。",
                        "接了独立货栈时，汇率默认按成交自动调。",
                        "例如 1:1.5 表示 1 本服 = 1.5 互通。",
                        "成功后物品从背包移除。",
                        "会给你一个 6 位取件码。",
                        "本服「我的上架」随时能再看，",
                        "也可以发给别人代领。",
                ...
                page("互通余额",
                        ...
                        "存入：扣本服货币，换成互通余额。",
                        "到另一台服取出：按那台服的汇率兑回。",
                        "例如 ES2 汇率 1:1.5，存入 10 → 互通 15。",
                        "SNC 汇率 1:1.2，取出可得 12.5。",
                        "同一游戏账号（UUID），不转给别人。",
                        "首次存入时，会告诉你一组 6 位钱包码，取出时需要输入。",
                        "之后可在钱包页随时再看，也可以改成更好记的数字。",
                        "若旧码已经无法再显示，请联系管理使用 /link pinreset。",
                        "聊天栏可输入金额，或输入 全部。"),
                page("聊天",
                        "大厅打开聊天选台：",
                        "发言：仅本服 / 全部互通服。",
